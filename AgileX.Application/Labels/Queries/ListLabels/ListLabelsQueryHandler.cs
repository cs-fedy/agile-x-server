...
public class ListLabelsQueryHandler : IRequestHandler<ListLabelsQuery, Result<List<Label>>>
{
    ...
    )
    {
        ...
        return _labelRepository.ListByTicketId(request.TicketId).Where(x => !x.IsDeleted).ToList();
    }
}
